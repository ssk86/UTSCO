...
from adapteacher.evaluation.visal_eval import PascalVOCDetectionEvaluator as MyVOCEval
...
def setup(args):
    ...
    """
    args.config_file= "configs/faster_rcnn_R101_cross_insulator.yaml"
    cfg = get_cfg()
...
if __name__ == "__main__":
    ...
    # args.num_gpus = 1        # 只使用一个 GPU
    # args.num_machines = 1    # 只有一台机器
    # args.machine_rank = 0    # 当前机器的 rank，单机时是 0
    # args.dist_url = "auto"   # 自动选择空闲端口进行通信
